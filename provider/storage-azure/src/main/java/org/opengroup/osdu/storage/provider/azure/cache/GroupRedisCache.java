...
public class GroupRedisCache extends RedisAzureCache<Groups> {

    public GroupRedisCache(final RedisConfig config) {
        super(Groups.class, config.createGroupConfiguration());
    }
}
