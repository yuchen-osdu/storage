...
public class StorageCorePlusApplication {
    ...
    public static void main(String[] args) {
        new SpringApplicationBuilder(StorageCorePlusApplication.class)
            .sources(StorageCorePlusApplication.class).web(WebApplicationType.NONE)
